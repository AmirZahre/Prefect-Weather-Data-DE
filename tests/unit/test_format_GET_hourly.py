...
from src.hourly_weather_update.tasks.format_GET_hourly_api_task import (
    format_GET_hourly_api,
)
...
actual_dataframe["date"] = pd.to_datetime(
    actual_dataframe['date'], format="%Y-%m-%d"
)  # formats datetime


"""
Test task 'format_GET_hourly_api' from
'format_GET_hourly_api_task' with test input
...
def test_format_GET_hourly_api():
    pd.testing.assert_frame_equal(
        format_GET_hourly_api.fn(raw_input),
        actual_dataframe,
        check_dtype=False,
    )
